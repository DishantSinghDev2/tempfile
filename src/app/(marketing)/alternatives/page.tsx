    ...
    <div className="max-w-4xl mx-auto py-20 px-6">
      ...
      <div className="grid gap-8">
        {alternatives.map((alt, i) => (
          <FadeIn key={alt.name} delay={i * 0.1}>
            <div className="border border-border rounded-xl p-8 hover:border-foreground/20 transition-colors bg-background">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 text-xs font-mono uppercase tracking-widest border-b border-foreground/20 pb-1 hover:border-foreground transition-colors"
              >
                In-depth comparison →
              </Link>
            </div>
